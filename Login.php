                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-12 border-bottom">
                        ...
                        <div class="container">
                            ...
                            <form action="" method="post" class="">
                                ...
                                <div class="text-warning lead" style="font-size: smaller;"><?php  echo $error['email']; ?></div>
                                <div class="form-group">
                                    <input type="password" name="password" autocomplete="off" required>
                                    <label for="password" class="lable-name"> <span class="content-name">Password</span> </label>
                                </div>
                                <div class="text-warning lead" style="font-size: smaller;"><?php  echo $error['password']; ?></div>
                                <div class="form-group h-100">
                                    <div><a href="./INDEX.php">Return to Home Page</a> |<br> <a href="Signup.php">Create New Account</a></div><br>
