    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9"><input type="text" name="unique_id" id="unique_id"
                                    class="form-control" placeholder="Enter Brand Name" aria-describedby="helpId"></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="#brand_name">Brand Name</label>
                            <div class="col-lg-9"><input type="text" name="brand_name" id="brand_name"
                                    class="form-control" placeholder="Enter Brand Name" aria-describedby="helpId"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea type="text" name="short_disc" id="short_disc" class="form-control"
                                placeholder="Enter the Breif Discription" aria-describedby="helpId" required></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea type="text" name="long_disc" id="long_disc" class="form-control"
                ...
                <div class="row">
                    <div class="col">
                        <input name="submit_product" id="submit_product" class="btn btn-primary" type="Submit"
                            value="Submit">
                    </div>
                </div>
            </form>
