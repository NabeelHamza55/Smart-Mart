                         ...
                         <table class="table table-hover align-middle">
                              ...
                              <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td class="align-middle"><button class="btn btn-primary" onclick="window.location.href='function/_del_category.php?id=<?php echo $category['id']; ?>'" ><i class="fa fa-trash"
                                                       aria-hidden="true"></i></button></td>
                                        <td class="align-middle"><button class="btn btn-primary" onclick="window.location.href='./_Category_edit.php?id=<?php echo $category['id']; ?>'"><i
