                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-12 border-bottom">
                        ...
                        <div class="container">
                            ...
                            <form action="" method="POST" class="">
                                ...
                                <div class="text-warning lead" style="font-size: smaller;"><?php  echo $errors['password']; ?></div>
                                <div class="form-group">
                                    <input type="password" name="confirm_pass" autocomplete="off" required>
                                    <label for="confirm_pass" class="lable-name"> <span class="content-name">Re-Enter Password</span> </label>                                    
                                </div>
                                <div class="text-warning lead" style="font-size: smaller;"><?php  echo $errors['password']; ?></div>
                                <div class="form-group h-100">
                                    <div><a href="#">Forget Password</a>|<a href="./Login.php">Login</a> | <a href="./INDEX.php">
