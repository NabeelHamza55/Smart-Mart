...
<div class="container bg-light">
                ...
                <div class="col-lg-5 col-sm-12 p-2 ">
                    <form action="./Functions/_insert_into_cart.php" method="post">
                        <div style="width: 100px;" class="input-group">
                            <input type="number" value="1" min="1" max="<?php echo $s_product['quantity']; ?>"
                                name="cart_quantity" class="form-control">
                            ...
                            <div style="width: 10px;" class="input-group-append">
                                <input type="submit" class="btn btn-primary" name="insert_into_cart"
                                    value="Add to Cart">
                            </div>
                        </div>
                    </form>
    ...
    <div class="container">
     ...
     if (isset($submit)) {
        ...
        $insert_data = "INSERT INTO COMMENTS (comment, username, email, product_name, rating) VALUES ('$comment',
        '$name', '$email', '$c_product_id', '$rating')";
        if (mysqli_query($db, $insert_data)) {
        echo "<script>
        alert('Successfull');
        </script>";
